...
> Forked from [ljg-card](https://github.com/lijigang/ljg-skills) by [@lijigang](https://github.com/lijigang).
...
```bash
node ~/.claude/skills/rainman-card/assets/capture.js <html> <png> <width> <height> [fullpage]
```

依赖：`~/.claude/skills/rainman-card/node_modules/` 中的 playwright。如报错：
